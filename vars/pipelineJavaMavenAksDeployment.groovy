...
def call(Map configuration) {
    ...
    pipeline {
        ...
        environment {
            ...
            DOCKER_CONTENT_TRUST_SERVER = "https://notary.gene.com"
        ...
        stages {
            stage("Initialization") {
                steps {
                    script {
                        ...
                        def paramsDriverObj = new PipelineParamsReaderDriver(this, 'PipelineParamsReaderAks')
            ...
            stage ("Deploy to Aks by ProvisioningCli") {
                when {
                    allOf {
                ...
                stages {
                    stage("Deploy to Aks by custom logics") {
                        steps {
                            script {
            ...
            stage ("Smoke Test") {
                ...
                steps {
                    script {
                        smoketestDriverObj = new SmokeTestDriver(this, 'SmokeTesterAks')
